...
const HomePageTemp = () => {
  ...
  return (
    <div className="homepage_root_container">
      ...
      <h1 className="simple_title">
        <span className="radiant_clients ">Technology </span> we used
      </h1>
      ...
      <div className="organizations_clinet">
        <div className="image_main_content_clinet">
          <div className="title_who_had">
            ...
            <div className="title_right">
              <figure className="animation_title">
      ...
      <h1 className="simple_title">
        Proud Memebr of <span className="radiant_clients ">Basis</span>
      </h1>
      <div className="section_of_certificate" >
        <div className="proud_member_besis">
          <img src={Basis} alt="" />
        </div>
      </div>
